...
**Administrador:** a lista da home é de **clientes** (nome/razão social, CPF ou CNPJ, plano, status), não de imóveis. Gestor e Analista continuam com a lista de imóveis.
